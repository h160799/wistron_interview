...
class DefaultTaipeiTravelRepository(private val taipeiTravelRemoteDataSource: TaipeiTravelDataSource,
    ...
    override suspend fun getAttractList(lang: String, page: Int?, nLat: Double, eLong: Double): ApiResult<Attraction> {
        return taipeiTravelRemoteDataSource.getAttractionList(lang = lang, page = page, nLat = nLat, eLong = eLong)
    }
}
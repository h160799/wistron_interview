...
import com.example.wistron_interview.data.TaipeiTravelDataSource
...
object TaipeiTravelRemoteDataSource: TaipeiTravelDataSource {
    override suspend fun getAttractionList(lang: String, page: Int?): ApiResult<Attraction> {
        ...
        return try {
            ...
            val result = TaipeiTravelApi.retrofitService.getAttractionList(lang=lang, page=page)
